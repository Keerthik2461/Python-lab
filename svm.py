# ======================
# SVM Spam Email Classifier with GUI
# ======================
...
df = pd.read_csv("SMSSpamCollection", sep='\t', names=['v1','v2'])
...
email_entry = tk.Text(root,
                      height=8,
                      width=70,
                      font=("Arial", 11))
email_entry.pack(pady=5)

predict_btn = ttk.Button(root,
                         text="Predict",
...
footer = ttk.Label(root,
                   text="SVM | Desktop ML Application",
                   font=("Arial", 10))
footer.pack(pady=10)
